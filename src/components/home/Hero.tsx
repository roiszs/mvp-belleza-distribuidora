...
<div className="absolute -left-14 top-10 h-44 w-44 rounded-full bg-[#ead8c8]/45 blur-3xl" />
<div className="absolute right-0 top-0 h-56 w-56 rounded-full bg-[#f2e7dc]/55 blur-3xl" />
<div className="absolute left-1/3 top-1/2 h-40 w-40 rounded-full bg-[#efe4d8]/25 blur-3xl" />
</div>
