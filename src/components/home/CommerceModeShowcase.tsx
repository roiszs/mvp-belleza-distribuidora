                ...
                return (
                  ...
                  >
                    <div className="rounded-[18px] bg-white p-4">
                      ...
                      <h4 className="mt-2 text-sm font-semibold leading-6 tracking-[-0.01em]">
                        {product.name}
                      </h4>
                      ...
                      {mode === 'b2b' && product.volumeTiers?.length ? (
                        ...
                        <div className="mt-4 rounded-full bg-[var(--color-soft)] px-3 py-2 text-[11px] font-medium uppercase tracking-[0.14em] text-[var(--color-text)]">
                          Compra individual
                        </div>
                      )}
                    </div>
