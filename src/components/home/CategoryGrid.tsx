...
<Container>
<div className="rounded-[30px] border border-[var(--color-line)] bg-white/72 p-5 shadow-[0_12px_28px_rgba(43,33,28,0.03)] backdrop-blur-sm md:p-6">
<SectionHeader
eyebrow="Categorías"
        ...
        {categories.map((category) => (
          ...
          >
            <div className="relative aspect-[4/3.5] overflow-hidden bg-[#efe5da] md:aspect-[4/3.9]">
              ...
              />
              <div className="absolute inset-0 bg-[linear-gradient(180deg,rgba(31,26,23,0.00)_45%,rgba(31,26,23,0.18)_100%)]" />
            ...
            <div className="p-4">
              <div className="flex items-center justify-between gap-3">
                <h3 className="text-base font-semibold tracking-[-0.02em]">{category.name}</h3>
