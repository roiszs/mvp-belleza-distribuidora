...
className="group flex h-full flex-col overflow-hidden rounded-[24px] border border-[var(--color-line)] bg-white transition duration-300 hover:-translate-y-1 hover:shadow-[0_16px_32px_rgba(43,33,28,0.05)]"
>
<div className="relative aspect-[4/3.9] overflow-hidden bg-[#f3ede6]">
{product.badge ? (
...
<Badge tone={product.isOnSale ? 'accent' : 'default'}>{product.badge}</Badge>
    ...
    <div className="absolute inset-0 bg-[linear-gradient(180deg,rgba(31,26,23,0.00)_55%,rgba(31,26,23,0.10)_100%)]" />
  </div>
